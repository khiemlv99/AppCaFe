...
namespace AppQuanLyBanCafe
{
    public class ExcelExport
    {
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case "nhapkho":
                    ...
                    arrByte = File.ReadAllBytes( "nhapkho.xlsx").ToArray();
                    break;

                case "tinhluong":

                    arrByte = File.ReadAllBytes("tinhluong.xlsx").ToArray();
                    break;
                case "doanhthu":

                    arrByte = File.ReadAllBytes("doanhthu.xlsx").ToArray();
                    break;
                case "ketca":

                    arrByte = File.ReadAllBytes("ketca.xlsx").ToArray();
                    break;
                #endregion
            }
            // Get stream
        ...
        public void ThanhPhanB1(ref Dictionary<string, string> replacer, int pTong)
        {
            if (replacer != null)
            {

                string NgayThangNam = "Ngay " + DateTime.Now.Day.ToString() + "Thang " + DateTime.Now.Month.ToString() + " Nam " + DateTime.Now.Year.ToString();
                string NgayThangNam1 = "Ngay " + DateTime.Now.Day.ToString() + "Thang " + DateTime.Now.Month.ToString() + " Nam " + DateTime.Now.Year.ToString();
                replacer.Add("%NgayThangNam",NgayThangNam);
                replacer.Add("%NgayThangNam1", NgayThangNam);
                replacer.Add("%Tong", pTong.ToString());
            }
        }
        public void ThanhPhanB3(ref Dictionary<string, string> replacer, double pTong)
        {
            if (replacer != null)
            {
                ...
                replacer.Add("%NgayThangNam", NgayThangNam);
                replacer.Add("%NgayThangNam1", NgayThangNam);
                replacer.Add("%TongTien", pTong.ToString());
            }
        }
        public void ThanhPhanB2(ref Dictionary<string, string> replacer, int pTong,int pthucte)
        {
            if (replacer != null)
            {
                ...
                replacer.Add("%NgayThangNam1", NgayThangNam);
                replacer.Add("%TongTien", pTong.ToString());
                replacer.Add("%ThucTe", pthucte.ToString());
            }
        }
        public bool ExportLuong(List<thongkeluong> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            ThanhPhanB1(ref replacer, dataSource.Count*150000);
            //  BuildReplacerCurrentDate(ref replacer);

            return OutSimpleReport(dataSource, replacer, "tinhluong", isPrintPreview, ref fileName);
        }

        public bool ExportKho(List<KhoNguyenLieu> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            if (dataSource == null || (dataSource != null && dataSource.Count == 0))
            {
            ...
            ThanhPhanB1(ref replacer, dataSource.Count );
            //  BuildReplacerCurrentDate(ref replacer);

            return OutSimpleReport(dataSource, replacer, "nhapkho", isPrintPreview, ref fileName);
        }

        public bool ExportDoanhthu(List<HoaDon> dataSource, ref string fileName, bool isPrintPreview,double tong)
        {
            // Check if data is null
            if (dataSource == null || (dataSource != null && dataSource.Count == 0))
            {
        ...
        public bool ExportKetca(List<HoaDon> dataSource, ref string fileName, bool isPrintPreview,int tong,int thucte)
        {
            // Check if data is null
            if (dataSource == null || (dataSource != null && dataSource.Count == 0))
            {
            ...
            ThanhPhanB2(ref replacer, tong,thucte);
            //  BuildReplacerCurrentDate(ref replacer);

            return OutSimpleReport(dataSource, replacer, "ketca", isPrintPreview, ref fileName);
        }
        #endregion
